...
const cardData = [
  {
    color: '#060010',
    title: '📄 ',
    description: 'View my full resume and work history',
    label: 'Resume'
  },
  {
    color: '#060010',
    title: '💻 ',
    description: 'React, JavaScript, Python, Java, Git, HTML/CSS',
    label: 'Skills'
  },
  {
    color: '#060010',
    title: '🎓 Education',
    description: 'B.S. Computer Science — expected graduation 2027',
    label: 'Academic'
  },
  {
    color: '#060010',
    title: '🚀 Projects',
    description: 'Personal website, web apps, and more',
    label: 'Portfolio'
  },
  {
    color: '#060010',
