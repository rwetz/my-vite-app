...
export const StaggeredMenu = ({
  ...
  className,
  logoUrl = "/src/assets/signature.png",
  menuButtonColor = "#fff",
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: flex-end; padding: 2em; background: transparent; pointer-events: none; z-index: 20; }.sm-scope .staggered-menu-header > * { pointer-events: auto; }
...
.sm-scope .staggered-menu-panel { position: absolute;
...
@media (max-width: 1024px) { .sm-scope .staggered-menu-panel { width: clamp(260px, 38vw, 420px); left: auto; right: 0; } .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); } }
@media (max-width: 640px) { .sm-scope .staggered-menu-panel { width: clamp(260px, 38vw, 420px); left: auto; right: 0; } .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); } }
      `}</style>
    </div>
  );
};
